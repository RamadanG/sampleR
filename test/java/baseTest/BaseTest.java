...
public class BaseTest {
    ...
    public void setup() throws MalformedURLException {
        ...
        commonAndroidCapabilities.setCapability("appActivity", "com.rainmanagement.rain.activity.MainActivity");
        commonAndroidCapabilities.setCapability("appPackage", "com.rainmanagement.rain.staging");
        ...
        commonAndroidCapabilities.setCapability("app", System.getProperty("user.dir") + "/src/main/resources/staging.apk");
